...
class Woo_Local_Pickup_Location_Admin {
	...
	private function __construct() {
		...
		add_action('add_meta_boxes_pickup_location', array( $this,'pickup_location_custom_box'));
        add_action('save_post_pickup_location', array( $this,'woo_pickup_location_metabox_save'));
    ...
    public function woo_register_pickup_location()
    {
    	register_post_type( 'pickup_location', array(
                'labels' => array(
                    ...
                    'all_items'          => __( 'Pickup Locations','woo-local-pickup'),
